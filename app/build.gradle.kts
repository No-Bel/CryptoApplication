...
dependencies {
    ...
    implementation("androidx.lifecycle:lifecycle-viewmodel-ktx:${rootProject.extra["coroutine_lifecycle_version"]}")
    implementation("androidx.lifecycle:lifecycle-runtime-ktx:${rootProject.extra["coroutine_lifecycle_version"]}")
